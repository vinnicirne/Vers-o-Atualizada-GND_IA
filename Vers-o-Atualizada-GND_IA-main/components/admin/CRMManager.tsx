...
export function CRMManager() {
    ...
    const newLeads = leads.filter(l => l.status_funil === 'new').length;
    const convertedLeads = leads.filter(l => l.status_funil === 'converted').length;
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs text-gray-500 uppercase font-bold">Novos (MQL)</p>
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs text-gray-500 uppercase font-bold">Vendas (Deals)</p>
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs text-gray-500 uppercase font-bold">Conversão</p>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 className="text-2xl font-bold text-[#263238] flex items-center gap-2">
                            <i className="fas fa-funnel-dollar text-green-600"></i> Pipeline de Vendas
                        </h2>
