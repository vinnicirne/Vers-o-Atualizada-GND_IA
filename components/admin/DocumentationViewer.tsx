...
-- 2. TABELA DE FEEDBACKS (Depoimentos)
...
-- 3. CAMPOS PARA SISTEMA DE AFILIADOS E PAGAMENTOS
...
-- 5. TABELA DE MEMÓRIA DO USUÁRIO
...
-- 6. TABELA DE DOMÍNIOS PERMITIDOS
      ...
      <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
        ...
        {activeTab === 'updates' && (
            <div className="prose prose-slate max-w-none">
                ...
                <p className="text-sm text-gray-500 mb-4">Execute este script no SQL Editor do Supabase para atualizar o banco de dados.</p>
